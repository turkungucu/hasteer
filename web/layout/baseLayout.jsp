...
<html>
    <head>
        ...
        <script type="text/javascript" src="/Hasteer/js/jquery.NobleCount.min.js"></script>
        <script type="text/javascript" src="/Hasteer/js/jquery.dataTables.min.js"></script>
        <script type="text/javascript" src="/Hasteer/js/jquery-ui-timepicker-addon-0.6.min.js"></script>
                ...
                <div class="main-body">
                    <div class="page-container-white">
                        <span class="page-title">
                            <tiles:getAsString name="page-title" ignore="true" />
                        </span>
                        <p/>
